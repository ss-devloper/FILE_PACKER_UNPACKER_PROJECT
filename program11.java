...
class program10
{
    public static void main(String A[]) throws Exception
    {
        ...
        if(fobj.exists())
        {
          ...
          frobj.read(Buffer,0,13);  // 0 isoffset 10 length if give 13 next ... dots also read

          System.out.println("Data from file is :"+new String(Buffer)); // converts character array to string // we also have toString() method 
